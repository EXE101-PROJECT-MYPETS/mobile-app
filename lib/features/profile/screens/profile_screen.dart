...
class _BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      currentIndex: 4, // Đang chọn "Tài khoản"
      selectedItemColor: const Color(0xFFE91E63), // Hồng đậm
      ...
      onTap: (index) {
        if (index == 0) {
          ...
          Navigator.pop(context); // Trở về nếu từ trang khác
        }
      },
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(LucideIcons.wrench), label: 'Dịch vụ'),
        BottomNavigationBarItem(icon: Icon(LucideIcons.store), label: 'Cửa hàng'),
        BottomNavigationBarItem(icon: Icon(LucideIcons.tag), label: 'Ưu đãi'),

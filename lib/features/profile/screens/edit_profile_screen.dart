      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: _newAvatar != null
                          ...
                          : (user?.avatarUrlPreview != null ? NetworkImage(avatarUrl) : null),
                      child: (_newAvatar == null && user?.avatarUrlPreview == null)
            ...
            _buildTextField('Số điện thoại', _phoneController, LucideIcons.phone),
            const SizedBox(height: 16),
            _buildTextField('Địa chỉ', _addressController, LucideIcons.mapPin),
            const SizedBox(height: 16),
            _buildTextField('Tuổi', _ageController, LucideIcons.calendar, keyboardType: TextInputType.number),
            const SizedBox(height: 32),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text('Chức năng Lưu đang được phát triển (Backend chưa có API cập nhật).'),

...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Widget build(BuildContext context) {
    var allProducts = context.watch<AppState>().allProducts;
...
// Widget thẻ sản phẩm đã được chuyển sang lib/shared/widgets/product_card.dart
...
class _BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      currentIndex: 2, // Đang chọn "Cửa hàng"
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(LucideIcons.bath), label: 'Spa'),

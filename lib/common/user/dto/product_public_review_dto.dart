class ProductPublicReviewDTO {
  ...
  factory ProductPublicReviewDTO.fromJson(Map<String, dynamic> json) {
    ...
    return ProductPublicReviewDTO(
      ...
      rating: (json['rating'] as num?)?.toDouble() ?? (json['star'] as num?)?.toDouble(),
      ...
      likeCount: json['likeCount'] as int? ?? json['helpfulCount'] as int? ?? json['usefulCount'] as int?,
      verifiedPurchase: json['verifiedPurchase'] as bool? ?? json['isVerified'] as bool?,
    );
  }
}
